...
const Footer = () => {
	...
	<div className="container flex flex-col justify-between py-10 mx-auto space-y-8 lg:flex-row lg:space-y-0">
		<div className="lg:w-1/3">
			<a rel="noopener noreferrer" href="#" className="flex justify-center space-x-3 lg:justify-start">
				...
				<span className="self-center text-4xl font-semibold">Bro Tech</span>
			</a>
		</div>
		<div className="grid grid-cols-2 text-sm gap-x-3 gap-y-8 lg:w-2/3 sm:grid-cols-4">
			<div className="space-y-3">
				<h3 className="tracking-wide uppercase dark:text-gray-50">Courses</h3>
	...
	<div className="py-6 text-sm text-center dark:text-gray-400">© 2022 Bro Tech. All rights reserved.</div>
</footer>
    );
};
