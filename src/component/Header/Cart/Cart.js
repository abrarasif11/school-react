...
const Cart = () => {
    return (
                ...
                <div className="flex w-full space-x-2 sm:space-x-4">
                    ...
                    <div className="flex flex-col justify-between w-full pb-4">
                        ...
                        <div className="flex text-sm divide-x">
                            <button type="button" className="bg-blue-400 hover:bg-blue-700 flex items-center px-2 py-1 pl-0 space-x-1">
                            ...
                            <button type="button" className="bg-blue-400 hover:bg-blue-700 flex items-center px-2 py-1 space-x-1">
                                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512" className="w-4 h-4 fill-current">
        ...
        <div className="flex justify-end space-x-4">
            <button type="button" className="bg-blue-400 hover:bg-blue-700 text-white px-6 py-2 border rounded-md dark:border-violet-400">Back
                <span className="sr-only sm:not-sr-only"> to courses</span>
            </button>
            <button type="button" className="bg-blue-400 hover:bg-blue-700 text-white px-6 py-2 border rounded-md dark:bg-violet-400 dark:text-gray-900 dark:border-violet-400">
